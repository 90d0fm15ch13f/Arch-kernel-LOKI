...
__attribute__((section("__versions"))) = {
	...
	{ 0x6b1b455d, __VMLINUX_SYMBOL_STR(snd_timer_global_new) },
	...
	{ 0x79912fe7, __VMLINUX_SYMBOL_STR(snd_timer_global_register) },
	{ 0x74b9f79b, __VMLINUX_SYMBOL_STR(hrtimer_try_to_cancel) },
	{ 0x9d17b90c, __VMLINUX_SYMBOL_STR(snd_timer_global_free) },
};
