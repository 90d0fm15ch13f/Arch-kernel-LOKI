...
__attribute__((section("__versions"))) = {
	...
	{ 0x20cce099, __VMLINUX_SYMBOL_STR(rt5645_set_jack_detect) },
	...
	{ 0x3edd4a5a, __VMLINUX_SYMBOL_STR(rt5645_sel_asrc_clk_src) },
...
"depends=snd-soc-core,snd-soc-rt5645,snd-pcm";
