...
__attribute__((section("__versions"))) = {
	...
	{ 0x8ff33da7, __VMLINUX_SYMBOL_STR(xts_twofish_setkey) },
	...
	{ 0x4f691ba5, __VMLINUX_SYMBOL_STR(lrw_twofish_exit_tfm) },
	...
	{ 0x7d46aa03, __VMLINUX_SYMBOL_STR(lrw_twofish_setkey) },
