	.file	"asm-offsets.c"
# GNU C89 (GCC) version 5.3.0 (x86_64-unknown-linux-gnu)
...
->__NR_syscall_max $326 sizeof(syscalls_64) - 1	#
# 0 "" 2
# 66 "arch/x86/kernel/asm-offsets_64.c" 1
	
->NR_syscalls $327 sizeof(syscalls_64)	#
# 0 "" 2
# 68 "arch/x86/kernel/asm-offsets_64.c" 1
	
->__NR_syscall_compat_max $377 sizeof(syscalls_ia32) - 1	#
# 0 "" 2
# 69 "arch/x86/kernel/asm-offsets_64.c" 1
	
->IA32_NR_syscalls $378 sizeof(syscalls_ia32)	#
# 0 "" 2
#NO_APP
	xorl	%eax, %eax	#
	popq	%rbp	#
