...
__attribute__((section("__versions"))) = {
	...
	{ 0x14bd198f, __VMLINUX_SYMBOL_STR(dvb_usbv2_generic_rw) },
	...
	{ 0xad04d655, __VMLINUX_SYMBOL_STR(dvb_usbv2_generic_write) },
};
...
MODULE_INFO(srcversion, "8EA09162F8E12411F7EDCA3");
