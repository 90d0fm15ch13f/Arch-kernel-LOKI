...
__attribute__((section("__versions"))) = {
	...
	{ 0xcf0a27c7, __VMLINUX_SYMBOL_STR(hid_sensor_pm_ops) },
	...
	{ 0x39dc4d16, __VMLINUX_SYMBOL_STR(sensor_hub_input_attr_get_raw_value) },
	{ 0xb54767de, __VMLINUX_SYMBOL_STR(hid_sensor_power_state) },
